...
public class StrBuilderExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		// 문자열은 fianl char배열임!! 즉 불변성을 가지고 있으므로 다른 문자열이 들어오면 새로 생성해버림.
		// 기존에 있던 문자열은 일정 시간동안 남아있고 그동안 재활용 가능.
		String str = "hello";
		...
		//java.lang 패키지에 있는 메서드들은 컴파일단계에서 자동으로 import 되므로 따로 import할 필요 없음.
		...
		System.out.println(sb.indexOf("ye"));
		sb.length();
		System.out.println("sb의 주소값: "+sb.hashCode());
