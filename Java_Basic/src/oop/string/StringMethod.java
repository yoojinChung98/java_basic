...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		String str = "hello java"; // 길이가 10인 문자열(공백포함)
		...
		String ss1 = str.substring(1, 5); //1번이상 5번 미만 (4개)
		...
		//length(): 문자열의 총 길이 반환.
		int len = str.length(); //배열의 .length는 배열의 속성값을 불러온거고, 이건 메서드를 부르는것();
		...
		// indexOf()는 앞에서부터 최초로 나오는 애의 인덱스 반환. lastIndexOf()는 뒤에서부터!
		
		//여러 문자를 전달하면 시작 인덱스를 알려줌. // 6
		...
		// 사용자의 입력값을 받아서 대소문자가 일정하게 들어오지 않을 때 사용
